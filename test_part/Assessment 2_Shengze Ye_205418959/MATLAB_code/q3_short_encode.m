...
[ll_start,ul_start] = get_ll_ul(start_prob,1/15);
ll_condition = cell(1, 9);
ul_condition = cell(1, 9);
for i = 1:9
    if (i == 1 || i == 3 || i == 7 || i == 9)
        [ll_condition{i}, ul_condition{i}] = get_ll_ul(condition_prob_1379, 1/15);
    elseif (i == 2 || i == 4 || i == 6 || i == 8)
        [ll_condition{i}, ul_condition{i}] = get_ll_ul(condition_prob_2468,1/15);
    else
        [ll_condition{i}, ul_condition{i}] = get_ll_ul(condition_prob_5,1/15);
    end
end
